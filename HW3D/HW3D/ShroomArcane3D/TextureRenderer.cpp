...
TextureRenderer::TextureRenderer(ShroomArcaneGraphics& gfx,
	...
	phi(adist(rng))
{
	...
	if (!IsStaticInitialized())
	{
		...
		model.Transform(DirectX::XMMatrixScaling(3.0f, 3.0f, 1.2f));

		AddStaticBind(std::make_unique<Texture>(gfx, Surface::FromFile("test2.png")));
